export default function Footer() {
  return (
    <footer className="w-full bg-gray-900 text-gray-300 p-10 mt-6">
      ...
      <div className="flex flex-col md:flex-row items-start justify-between"> 
        ...
        <section>
          ...
          <p className="text-sm"> GitHub: <a
              href="https://github.com/Laitech001"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-blue-500"
            >
              github.com/Laitech001
            </a>
          </p>
        </section>
      </div>

      <p className="text-sm text-center mt-6">&copy; {new Date().getFullYear()} Laitech. All rights reserved.</p>
